...
def run(sys_args):
    ...
    while True:
        ...
        args['model']['pair_degree_feature'] = np.int(np.random.choice(pair_degree_feature, p=[0.5, 0.5]))
        ...
        train_dataset = LightDataset(row_id_to_idx, col_id_to_idx, propagation_scores,
                                     ...
                                     args['data']['normalization_method'], normalization_constants, None,
...
if __name__ == '__main__':
    ...
    n_exp = 2
    split = [0.66, 0.14, 0.2]
    interaction_type = ['KPI','STKE', 'EGFR','E3', 'PDI']
    prop_scores_filename = 'drug_KPI_STKE_EGFR_E3_PDI'
    ...
    parser.add_argument('-d', '--device', type=str, help='cpu or gpu number',  default=None)
    parser.add_argument('-in', '--inter_file', dest='directed_interactions_filename', nargs='*', type=str, help='KPI/STKE',
